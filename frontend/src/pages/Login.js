  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 pt-24">
      <div className="max-w-md w-full">
        <div className="theme-card backdrop-blur-sm p-8 rounded-2xl shadow-2xl animate-slide-up">
          <div className="text-center mb-8">
            ...
            <p className="theme-text-secondary">Sign in to your Farm2Home account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full p-4 theme-border rounded-xl focus:ring-2 focus:ring-blue-300 focus:border-transparent transition-all duration-200 theme-card theme-text-primary"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-4 theme-border rounded-xl focus:ring-2 focus:ring-blue-300 focus:border-transparent transition-all duration-200 theme-card theme-text-primary pr-12"
                ...
                <button
                  type="button"
                  className="absolute right-4 top-4 theme-text-secondary hover:opacity-70 transition-colors duration-200"
